...
document.querySelector(".style2").addEventListener("click", function() {
    document.querySelector("#maincontent").style.backgroundImage = "url('images/Purple-Haze.jpg')";
});

// Part 3 Question 8
document.querySelectorAll(".partA a").forEach(function(a){
